...
class CTReportDataset(Dataset):
    def __init__(self, data_folder, csv_file, min_slices=20, resize_dim=500, force_num_frames=True):
        ...
        self.count = 0
        self.df_meta = pd.read_csv("/mnt/datalake/DS-lake/vankhoa/CT-RATE/dataset/metadata/train_metadata.csv") #select the metadata
    ...
    def nii_img_to_tensor(self, path, transform):
        ...
        row = self.df_meta[self.df_meta['VolumeName'] == file_name]
